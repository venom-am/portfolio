...
export function ShootingStarsAndStarsBackgroundDemo() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-neutral-900 rounded-md mg-auto m-0 p-0">
      <div className="flex flex-col md:flex-row items-center justify-between w-full px-4 sm:px-6 md:px-8 lg:px-10 py-4 sm:py-6 md:py-8 gap-4 sm:gap-6 md:gap-8 mt-16 sm:mt-20">
