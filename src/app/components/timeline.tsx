...
export function TimelineDemo() {
  const data = [
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm text-white">
            I started my journey as a full stack developer in 2024.
          </p>
  ...
  return (
    <div className="bg-neutral-900 relative w-full overflow-clip">
      <Timeline data={data} />
    </div>
  );
}
